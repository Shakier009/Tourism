...
//
//@RestController
//@RequestMapping("/tourism/Resturants")
...
//    public @ResponseBody
//    Resturants create(@PathVariable  String restName, String restBooking){
//        Resturants resturants = ResturantsFactory.getResturants(restName, restBooking);
